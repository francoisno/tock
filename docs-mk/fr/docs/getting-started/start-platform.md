...
[manuel utilisateur](../user-manual/toc.md) vous en apprendra plus sur l'architecture, les possibilités et les 
...
>
> D'autres modes que Kotlin et _WebSocket_ sont présentés dans le [manuel utilisateur Tock](../user-manual/toc.md).
...
Comme dans le guide [premier bot](start-studio.md) utilisant la plateforme de démonstration, vous allez créer une 
...
Comme dans le guide [programmer des parcours](start-api.md) utilisant la plateforme de démonstration, vous allez créer une 
...
* Créez un projet Kotlin par exemple avec Maven comme indiqué dans le guide [programmer des parcours](start-api.md)
...
[manuel utilisateur](../user-manual/toc.md) pour en savoir plus sur _Tock Studio_, _Bot API_ et _Bot Flow_ par exemple.
